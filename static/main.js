...
async function getBids() {
  let resp = await fetch(`http://localhost:3000/lots/${lotId}/bids`, {    
    headers: {
      Authorization:
        'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InBhdmxvdmEyQGdvb2dsZS5jb20iLCJpYXQiOjE1ODA4OTkwODcsImV4cCI6MTU4MDkwMjY4N30.-wlJo6rdaxZPsTlhA0KHC53ykIEwDjin9pt2A_Nn_Hs',
    },
  });
